...
import { U as Users, S as Sessions } from '../../chunks/index_DBharnCd.mjs';
import { P as PATH } from '../../chunks/consts_CBnhyY32.mjs';
...
const POST = async ({ request, locals, cookies }) => {
  try {
    ...
    if (!username) return http.failure(400, "invalid_username");
    if (!password) return http.failure(400, "invalid_password");
    ...
    return WebResponse.redirect(PATH.ADMIN_LOGIN({ error }), 302);
  }
};
