...
import { manifest } from './manifest_CTw2jxz4.mjs';
...
const _page2 = () => import('./pages/admin/system.astro.mjs');
...
const _page6 = () => import('./pages/api/exec.astro.mjs');
const _page7 = () => import('./pages/api/proxy.astro.mjs');
const _page8 = () => import('./pages/api/session.astro.mjs');
const _page9 = () => import('./pages/api/shell/stream.astro.mjs');
const _page10 = () => import('./pages/api/shell.astro.mjs');
const _page11 = () => import('./pages/api/stream.astro.mjs');
...
const _page19 = () => import('./pages/logout.astro.mjs');
const _page20 = () => import('./pages/rss.xml.astro.mjs');
const _page21 = () => import('./pages/index.astro.mjs');
const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/about.astro", _page1],
    ["src/pages/admin/system.astro", _page2],
    ["src/pages/admin/index.astro", _page3],
    ["src/pages/api/analytics/index.ts", _page4],
    ["src/pages/api/auth.ts", _page5],
    ["src/pages/api/exec.ts", _page6],
    ["src/pages/api/proxy.ts", _page7],
    ["src/pages/api/session.ts", _page8],
    ["src/pages/api/shell/stream.ts", _page9],
    ["src/pages/api/shell/index.ts", _page10],
    ["src/pages/api/stream.ts", _page11],
    ...
    ["src/pages/login/index.astro", _page18],
    ["src/pages/logout/index.astro", _page19],
