...
import { manifest } from './manifest_CoWiAShO.mjs';
...
const _page9 = () => import('./pages/api/proxy.astro.mjs');
const _page10 = () => import('./pages/api/session.astro.mjs');
const _page11 = () => import('./pages/api/shell/exec.astro.mjs');
const _page12 = () => import('./pages/api/shell/stream.astro.mjs');
const _page13 = () => import('./pages/api/system/command.astro.mjs');
const _page14 = () => import('./pages/api/system/info.astro.mjs');
const _page15 = () => import('./pages/api.astro.mjs');
const _page16 = () => import('./pages/blog.astro.mjs');
const _page17 = () => import('./pages/blog/_---slug_.astro.mjs');
const _page18 = () => import('./pages/code.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/proxy/index.ts", _page9],
    ["src/pages/api/session/index.ts", _page10],
    ["src/pages/api/shell/exec.ts", _page11],
    ["src/pages/api/shell/stream.ts", _page12],
    ["src/pages/api/system/command.ts", _page13],
    ["src/pages/api/system/info.ts", _page14],
    ["src/pages/api/index.ts", _page15],
    ["src/pages/blog/index.astro", _page16],
    ["src/pages/blog/[...slug].astro", _page17],
    ["src/pages/code/index.astro", _page18],
