import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, r as renderTemplate, d as renderComponent } from './astro/server_CrxpYex7.mjs';
import 'kleur/colors';
import { P as PATH } from './consts_CF0Pd1PO.mjs';
...
const $$AdminPanelSidebarButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(onClickHref, "href")}${addAttribute(clsx("flex flex-col flex-shrink justify-end", active ? "opacity-100" : "opacity-80"), "class")}> <button${addAttribute(onClickForm, "type")}${addAttribute(
    clsx("flex flex-row gap-x-3 items-center justify-start rounded-md px-2 py-1 mx-2 bg-opacity-0 hover:bg-opacity-70", {
