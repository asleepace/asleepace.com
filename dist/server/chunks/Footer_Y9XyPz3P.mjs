import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, s as spreadAttributes, f as renderSlot, r as renderTemplate, d as renderComponent, g as renderScript } from './astro/server_CrxpYex7.mjs';
import 'kleur/colors';
/* empty css                         */
import 'clsx';
import { b as SITE_TITLE } from './consts_CF0Pd1PO.mjs';
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="w-full" data-astro-cid-lejjx2fa>
