...
<a href="/code"><button className="bg-blue-500 hover:bg-blue-400 hover:underline w-full py-4 rounded-xl text-white">Click to open online text editor!</button></a>
